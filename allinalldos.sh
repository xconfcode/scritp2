...
# [[ Mounting ]] 
# ==================================================================================
echo -e "\nstarted Mounting only to root bcz dos scheme \n"
mount  /dev/"${ROOT}" /mnt
#mkdir /boot/efi
...
pacman -S grub efibootmgr os-prober mtools dosfstools networkmanager network-manager-applet wpa_supplicant dialog base-devel linux-headers  cups openssh blueman git  nano vim neovim   --noconfirm
...
echo "Creating boot directory ..skiping"
#mkdir /boot/efi
